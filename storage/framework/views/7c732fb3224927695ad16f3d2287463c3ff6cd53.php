                   	...
                   	<div class="row">
                   		<div class="col-lg-4 col-md-4 login_div">
                               ...
                               <div class="col-lg-12 login_logo">
                                    <img src="<?php echo e(MyFunctions::getLogo()); ?>" alt="" width="40%"/>					
                                </div>
                   				<div class="form-main">
...
<?php echo $__env->make('layouts.admin_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mide_dickson/klips/laravel_admin/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>